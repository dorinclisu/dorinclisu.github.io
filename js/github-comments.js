async function getComments(repo_name, comment_id, page_id, acc )
{
    ...
    if (1 == page_id) {
        ...
        acc += ("<form action='" + url + "' rel='nofollow'> <input type='submit' value='Post a comment using GitHub' /> </form>");
    }

    comments.reverse();  // show the most recent ones first
    ...
    for (let i = 0; i < comments.length; i++)
    {
        ...
        acc += " - ";
        acc += "<em>" + date.toLocaleString(undefined, {timeZoneName: 'short'}) + "</em>";
